...
class DialogueNotification extends StatelessWidget {
  final NotificationModel notificationModel;
  DialogueNotification({required this.notificationModel});
              ...
              Container(
                ...
                child: ClipRRect(
                  ...
                  child: CustomImage(
                    ...
                    height: 150, width: MediaQuery.of(context).size.width, fit: BoxFit.cover, placeholder: '',
                  ),
                ),
              ),
